                        ...
                        ? Container(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                  ...
                                  children: [
                                    Text(""),
                                    Text(now.toString(),style:TextStyle(color:Colors.grey.shade900,fontWeight:FontWeight.bold)),
                                    Text(""),
                                ...
                                MaterialPageRoute(
                                  builder: (context) => FriendMess(
                                    ...
                                    Stack(children: [
                                      ...v2prime.map((rt)=>rt['useryou'] == widget.miuser && rt ['datetime'].split('|')[0]==now.toString() && rt['checkIn']=='done'&& rt['driver'] == sky4[hot1]
                                                      ["nameq"].toString() ?Container(
                                      decoration: BoxDecoration(
                                      ...
                                      child: ListTile(
                                          leading: Icon(Icons.school,
                                              color: Colors.white),
                                          title: Text("BusStop Check in",
                                              style: TextStyle(
                                                  color: Colors.white)),
                                          subtitle: Text(rt ['datetime'].split('|')[1].toString()),
                                          trailing: Checkbox(
                                            value: true,
                                            onChanged: (v) {
                                              //y
                                    ...
                                    ):SizedBox()).toList(),//.getRange(v2prime.length - 1, v2prime.length),//.take(5),
                                    SizedBox(height:10),
                                    ...v2prime.map((rt)=>rt['useryou'] == widget.miuser && rt ['datetime'].split('|')[0]==now.toString() && rt['checkout'] == 'done' && rt['driver'] == sky4[hot1]
                                                      ["nameq"].toString() ?Container(
                                      decoration: BoxDecoration(
                                        color: Colors.grey.shade900
                                            .withOpacity(0.5),
